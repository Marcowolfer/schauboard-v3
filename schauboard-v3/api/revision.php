...
// aktive Playlist wechselt (ohne Datei-Aenderung). So erkennt der 5s-Poll des
// Displays auch reine Tageszeit-Umschaltungen und laedt neu.
...
echo json_encode(['ok' => true, 'revision' => schauboard_display_revision($display, $schedules, $now)]);
