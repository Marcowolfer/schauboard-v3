...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    echo json_encode(['ok' => true, 'data' => schauboard_read_dataset('schedules')]);
    exit;
}
...
$items = array_values(array_map('schauboard_sanitize_schedule', $payload['items']));
if (!schauboard_write_dataset('schedules', $items)) {
